...
<html>
  ...
  <body>
   ...
   $(document).ready(function(){
	    ...
	    var id="dg";
	    var title="&nbsp;人员信息";
	    var url="../servlet/UserOPGridData";
	    /*定义带有分页的网格*/
   ...
   function getDefColumnArray(temp){
	   return columnArray1=[[
     			{field:'id',title:'序号',width:20,checkbox:true,sortable:true,align:'center'},
  				{field:'uid',title:'账号',width:100,align:'center',
     				editor:{
     					type:'textbox',
     					options:{
	     					disabled:temp,
  				...
  				{field:'birthdate',title:'出生年月',width:100,align:'center',editor:'datebox'},
  				{field:'utype',title:'角色',width:100,align:'center',
  					editor:{type:'combobox',options:{
  						valueField:'text',
  						textField:'text',
  						method:'get',
  				...
  				{field:'phone',title:'联系电话',width:100,align:'center',editor:'textbox'}
  		    ]];
   }
   </script>
  </body>
